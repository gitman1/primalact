...
const socialLinks = [
  ...
  },
  {
    ...
    icon: (
      <path d="M21.6 7.2s-.21-1.5-.87-2.16c-.83-.87-1.76-.87-2.19-.92C15.44 4 12 4 12 4h-.01s-3.44 0-6.53.12c-.43.05-1.36.05-2.19.92C2.6 5.7 2.4 7.2 2.4 7.2S2.19 8.94 2.19 10.7v1.6c0 1.75.21 3.5.21 3.5s.2 1.5.86 2.16c.83.87 1.92.84 2.4.93 1.75.17 7.34.22 7.34.22s3.44-.01 6.54-.12c.43-.05 1.36-.05 2.19-.92.66-.66.87-2.16.87-2.16s.21-1.75.21-3.5v-1.6c0-1.76-.21-3.5-.21-3.5ZM9.75 14.9V8.9l5.75 3-5.75 3Z" />
    ),
  },
];
